...
namespace HCMS.DataAccess.Migrations
{
    ...
    [Migration("20240524193940_SeedHosData")]
    partial class SeedHosData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HCMS.Models.Admission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AdmissionId = 1,
                            AdmissionDate = new DateTime(2024, 5, 14, 22, 39, 37, 382, DateTimeKind.Local).AddTicks(1855),
                            AdmissionNotes = "Patient admitted for evaluation of chest pain.",
                            AttendingDoctorId = 1,
                            BedNumber = "C123",
                            Department = "Cardiology",
                            DischargeDate = new DateTime(2024, 5, 22, 22, 39, 37, 382, DateTimeKind.Local).AddTicks(1913),
            ...
            modelBuilder.Entity("HCMS.Models.Medication", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MedicationId = 1,
                            Dosage = "10mg",
                            EndDate = new DateTime(2024, 10, 24, 22, 39, 37, 382, DateTimeKind.Local).AddTicks(1959),
                            MedicationName = "Lisinopril",
                            PatientId = 1,
                            StartDate = new DateTime(2024, 4, 24, 22, 39, 37, 382, DateTimeKind.Local).AddTicks(1949)
                        });
                });
            ...
            modelBuilder.Entity("HCMS.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PatientId = 1,
                            Address = "123 Main St",
                            AdmissionDate = new DateTime(2024, 5, 14, 22, 39, 37, 382, DateTimeKind.Local).AddTicks(2001),
                            Age = 45,
                            Allergies = "Peanuts",
